...
import { isHTMLElement } from './instanceOf' // isShadowRoot
...
function getTrueOffsetParent(element: Element) {
  if (
...
function getContainingBlock(element: Element) {
  ...
  if (isShadowRootLocal(currentNode))
  ...
  while (
    ...
    const css = getComputedStyle(currentNode as Element) // This is non-exhaustive but covers the most common CSS properties that
